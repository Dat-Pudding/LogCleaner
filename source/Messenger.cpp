...
void XMCleaner::Messenger::ErrorMsg_BadOutput(std::string filterMode)
{
	if (filterMode == "-h")
	{
		std::cout << "Couldn't find hash log, trying to generate a new one..." << std::endl;
		system("pause");
	}
	else if (filterMode == "-j")
	{
		std::cout << "Couldn't find job log, trying to generate a new one..." << std::endl;
		system("pause");
	}
	else if (filterMode == "-s")
	{
		std::cout << "Couldn't find share log, trying to generate a new one..." << std::endl;
		system("pause");
	}
}
